...
subroutine out_emf(n)
   ...
   if((n-ostart).eq.0) then
      if(comp(1).eq.1) then
         ...
         call wrt2d(file_id(1),group_id(1),"0000",dims,ex(is:ie:stride,js:je:stride),istat1(1),istat2(1))
         call hdfclose(file_id(1),group_id(1),error(1))
      endif
      if(comp(2).eq.1) then
         call hdfopen(filename(2),groupname(2),file_id(2),group_id(2),0)
         call wrt2d(file_id(2),group_id(2),"0000",dims,ey(is:ie:stride,js:je:stride),istat1(2),istat2(2))
         call hdfclose(file_id(2),group_id(2),error(2))
      endif
      if(comp(3).eq.1) then
         call hdfopen(filename(3),groupname(3),file_id(3),group_id(3),0)
         call wrt2d(file_id(3),group_id(3),"0000",dims,ez(is:ie:stride,js:je:stride),istat1(3),istat2(3))
         call hdfclose(file_id(3),group_id(3),error(3))
      endif
      if(comp(4).eq.1) then
         call hdfopen(filename(4),groupname(4),file_id(4),group_id(4),0)
         call wrt2d(file_id(4),group_id(4),"0000",dims,hx(is:ie:stride,js:je:stride),istat1(4),istat2(4))
         call hdfclose(file_id(4),group_id(4),error(4))
      endif
      if(comp(5).eq.1) then
         call hdfopen(filename(5),groupname(5),file_id(5),group_id(5),0)
         call wrt2d(file_id(5),group_id(5),"0000",dims,hy(is:ie:stride,js:je:stride),istat1(5),istat2(5))
         call hdfclose(file_id(5),group_id(5),error(5))
      endif
      if(comp(6).eq.1) then
         call hdfopen(filename(6),groupname(6),file_id(6),group_id(6),0)
         call wrt2d(file_id(6),group_id(6),"0000",dims,hz(is:ie:stride,js:je:stride),istat1(6),istat2(6))
         call hdfclose(file_id(6),group_id(6),error(6))
      endif
      if(comp(7).eq.1) then
         call hdfopen(filename(7),groupname(7),file_id(7),group_id(7),0)
         call wrt2d(file_id(7),group_id(7),"0000",dims,jx(is:ie:stride,js:je:stride),istat1(7),istat2(7))
         call hdfclose(file_id(7),group_id(7),error(7))
      endif
      if(comp(8).eq.1) then
         call hdfopen(filename(8),groupname(8),file_id(8),group_id(8),0)
         call wrt2d(file_id(8),group_id(8),"0000",dims,jy(is:ie:stride,js:je:stride),istat1(8),istat2(8))
         call hdfclose(file_id(8),group_id(8),error(8))
      endif
      if(comp(9).eq.1) then
         call hdfopen(filename(9),groupname(9),file_id(9),group_id(9),0)
         call wrt2d(file_id(9),group_id(9),"0000",dims,jz(is:ie:stride,js:je:stride),istat1(9),istat2(9))
         call hdfclose(file_id(9),group_id(9),error(9))
      endif
   elseif(mod(int(n-ostart),out).eq.0.and.n-ostart.gt.0.0d0) then
      h5count = h5count + 1  
      ...
      if(comp(7).eq.1) then
         call hdfopen(filename(7),groupname(7),file_id(7),group_id(7),1)
         call wrt2d(file_id(7),group_id(7),tag,dims,jx(is:ie:stride,js:je:stride),istat1(7),istat2(7))
         call hdfclose(file_id(7),group_id(7),error(7))
      endif
      if(comp(8).eq.1) then
         call hdfopen(filename(8),groupname(8),file_id(8),group_id(8),1)
         call wrt2d(file_id(8),group_id(8),tag,dims,jy(is:ie:stride,js:je:stride),istat1(8),istat2(8))
         call hdfclose(file_id(8),group_id(8),error(8))
      endif
      if(comp(9).eq.1) then
         call hdfopen(filename(9),groupname(9),file_id(9),group_id(9),1)
